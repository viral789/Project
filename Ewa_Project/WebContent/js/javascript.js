...
function appendProduct(hotelName) {
    ...
    linkElement.setAttribute("href", "AutoComplete?action=lookup&hotelname=" + hotelName);
...
function parseMessages(responseXML) {
    ...
    if (responseXML == null) {
        ...
        var hotels = responseXML.getElementsByTagName("hotel")[0];
